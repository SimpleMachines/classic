...
<table width="100%" cellpadding="3" cellspacing="0">
	...
	echo '
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder borderbottom">
	<tr>
	...
	echo '
					...
					<td align="right" class="fontsmall">', theme_show_main_buttons(), '</td>
				</tr>
			</table>
		</td>
	</tr>
	...
	{
		echo '
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder borderbottom">
	<tr class="titlebg">
		<td colspan="2" valign="middle" align="left" class="pollicons">
	...
	<tr class="windowbg">
		...
		if ($context['poll']['show_results'] || !$context['allow_vote'])
		{
			...
			foreach ($context['poll']['options'] as $option)
				echo '
							<tr>
								<td', $option['voted_this'] ? ' class="bold"' : '', '>', $option['option'], '</td>', $context['allow_poll_view'] ? '
								<td width="7">&nbsp;</td>
			...
			echo '
					...
					<td valign="bottom" class="paddingleft15">';
		...
		{
			echo '
			<form action="', $scripturl, '?action=vote;topic=', $context['current_topic'], '.', $context['start'], ';poll=', $context['poll']['id'], '" method="post" accept-charset="', $context['character_set'], '" class="nomargin">
				<table>
					<tr>
						<td colspan="2">';
...
<table cellpadding="3" cellspacing="0" border="0" width="100%" class="tborder">
	...
	<tr class="windowbg">
		...
		foreach ($context['linked_calendar_events'] as $event)
		{
			echo '
				<li>
					<strong>', ($event['can_edit'] ? '<a href="' . $event['modify_href'] . '" class="red">*</a> ' : ''), $event['title'], '</strong>: ', $event['start_date'], ($event['start_date'] != $event['end_date'] ? ' - ' . $event['end_date'] : '');
			echo '
				</li>';
		}
		echo '
	...
	echo '
<table cellpadding="3" cellspacing="0" border="0" width="100%" align="center" class="tborder borderbottom">
	<tr class="titlebg">
		<td valign="middle" align="left" width="15%" class="pollicons">
			<img src="', $settings['images_url'], '/topic/', $context['class'], '.gif" alt="" />
			', $txt['author'], '
		</td>
		<td valign="middle" align="left" width="85%" class="pollicons" id="top_subject">
	...
	echo '
<form action="', $scripturl, '?action=quickmod2;topic=', $context['current_topic'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" name="quickModForm" id="quickModForm" class="nomargin" onsubmit="return oQuickModify.bInEditMode ? oQuickModify.modifySave(\'' . $context['session_id'] . '\', \'' . $context['session_id'] . '\') : false;">';
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="bordercolor">';
	...
	<tr><td class="messagepadding">';
						...
						<td valign="top" width="85%" height="100%">
							<table width="100%" border="0"><tr>
								...
								<td align="left" valign="middle">
									<div class="bold" id="subject_', $message['id'], '">
		...
		echo '
								...
								<td align="right" valign="bottom" height="20" nowrap="nowrap" class="fontsmall">';
		...
		if (!empty($options['display_quick_mod']) && $options['display_quick_mod'] == 1 && $message['can_remove'])
			echo '
									<div class="displaynone" id="in_topic_mod_check_', $message['id'], '"></div>';
		...
		echo '
							...
							<img src="' . $settings['images_url'] . '/icons/modify_inline.gif" alt="" title="' . $txt['modify_msg'] . '" align="right" id="modify_button_' . $message['id'] . '" class="pointer" onclick="oQuickModify.modifyMsg(\'' . $message['id'] . '\', \'' . $context['session_id'] . '\', \'' . $context['session_var'] . '\')" />' : '', '
						</td>
					</tr>';
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	echo '
		...
		<td align="left" colspan="2" class="paddingtop" id="moderationbuttons">
...
<table border="0" cellspacing="1" cellpadding="3" class="clear bordercolor" width="100%">
	...
	<tr id="quickReplyOptions"', $options['display_quick_reply'] == 2 ? '' : ' class="displaynone"', '>
		...
		<td class="windowbg" width="75%" align="center">
			...
			<form action="', $scripturl, '?action=post2" method="post" accept-charset="', $context['character_set'], '" name="postmodify" id="postmodify" class="nomargin">
		...
		echo '
				<textarea cols="75" rows="7" class="txtarea" name="message" tabindex="1"></textarea><br />
		...
		var oQuickModify = new QuickModify({
			...
			sTemplateBodyEdit: ', JavaScriptEscape('
				<div id="quick_edit_body_container">
					<div id="error_box" class="error padding4"></div>
					<textarea class="deditor" name="message" rows="12" tabindex="7">%body%</textarea><br />
					<input type="hidden" name="' . $context['session_var'] . '" value="' . $context['session_id'] . '" />
					<input type="hidden" name="topic" value="' . $context['current_topic'] . '" />
			...
			sTemplateSubjectEdit: ', JavaScriptEscape('<input type="text" class="w90" name="subject" value="%subject%" size="80" maxlength="80" tabindex="6" class="input_text" />'), ',
