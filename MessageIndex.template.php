...
function template_main()
{
	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		<div class="table_frame">
			<table class="table_list table_border" cellspacing="1" cellpadding="4">
				<thead>
					<tr class="titlebg">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if (!empty($board['moderators']))
				echo '
						<em class="smalltext">', count($board['moderators']) == 1 ? $txt['moderator'] : $txt['moderators'], ': ', implode(', ', $board['link_moderators']), '</em><br />';
			...
			if (!empty($board['children']))
			{
				...
				echo '
					<em class="smalltext">', $txt['parent_boards'], ': ', implode(', ', $children), '</em>';
			}

			// Show some basic information about the number of posts, etc.
			echo '
					</td>
					<td class="stats windowbg" ', $board['is_redirect'] ? 'colspan="2"' : '' ,'>
						<p>', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['board_topics'], '</p>
					</td>
					<td class="stats windowbg">
						<p>', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['posts'] . '</p>
					</td>					
					<td class="lastpost">';
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($context['topics']))
		{
			echo '
					...
					<th scope="col" class="lefttext"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['subject'], $context['sort_by'] == 'subject' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
					<th width="14%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" border="0" />' : '', '</a></th>
		...
		foreach ($context['topics'] as $topic)
		{
			...
			// Last, but not least: regular topics.
				...
				$color_class = 'windowbg2';

			// Some columns require a different shade of the color class.
			$alternate_class = substr($color_class, 0, 8);
			...
			echo '
							<p><small id="pages' . $topic['first_post']['id'] . '">', $topic['pages'], '</small></p>
						</div>
					</td>
					<td class="', $color_class ,'">', $topic['first_post']['member']['link'], '</td>
