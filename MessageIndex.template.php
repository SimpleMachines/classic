...
<br />';
	...
	{
		echo '
<table width="100%" cellpadding="6" cellspacing="0" border="0" class="tborder borderwidth">
	<tr>
	...
	{
		echo '
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder borderwidth">
	<tr>
		<td align="left" class="catbg" width="100%" height="30">
			<table cellpadding="3" cellspacing="0" width="100%">
				<tr>
					...
					<td align="right" nowrap="nowrap" class="fontsmall">', theme_show_buttons(), '</td>
				</tr>
			</table>
		</td>
	</tr>
		...
		if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1 && !empty($context['topics']))
			echo '
<form action="', $scripturl, '?action=quickmod;board=', $context['current_board'], '.', $context['start'], '" method="post" accept-charset="', $context['character_set'], '" class="nomargin">';
...
<table border="0" width="100%" cellspacing="1" cellpadding="4" class="bordercolor">
	...
	<input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
		...
		echo '
<table width="100%" cellpadding="3" cellspacing="0" border="0" class="tborder borderwidth2">
	<tr>
		<td align="left" class="catbg" width="100%" height="30">
			<table cellpadding="3" cellspacing="0" width="100%">
				<tr>
...
<table cellpadding="0" cellspacing="0" width="100%">';
	...
	{
		echo '
		<td class="smalltext breadcrumbpadding" align="left">', !empty($modSettings['enableParticipation']) && $context['user']['is_logged'] ? '
		...
		<td class="smalltext breadcrumbpadding" align="left" valign="top" >
